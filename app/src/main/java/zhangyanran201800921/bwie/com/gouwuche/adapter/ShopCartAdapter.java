package zhangyanran201800921.bwie.com.gouwuche.adapter;
...
import zhangyanran201800921.bwie.com.gouwuche.activity.MainActivity;
...
import zhangyanran201800921.bwie.com.gouwuche.holder.ShopCartHolder;
...
public class ShopCartAdapter extends RecyclerView.Adapter<ShopCartHolder> {
    ...
    Context context;
    List<ShopBean.DataBean.ListBean> data;
